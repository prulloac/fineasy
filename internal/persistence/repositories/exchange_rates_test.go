...
func TestInsertExchangeRate(t *testing.T) {
	...
	exchangeRate := entity.ExchangeRate{CurrencyID: 1, GroupID: 1, Rate: 1.0, Date: time.Now()}
...
func TestUpdateExchangeRate(t *testing.T) {
	...
	exchangeRate := entity.ExchangeRate{ID: 1, CurrencyID: 1, GroupID: 1, Rate: 1.0, Date: time.Now()}
