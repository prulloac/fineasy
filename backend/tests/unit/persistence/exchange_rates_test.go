...
func TestInsertExchangeRate(t *testing.T) {
	...
	err = p.GetExchangeRateRepository().InsertExchangeRate(exchangeRate)
...
func TestGetExchangeRates(t *testing.T) {
	...
	var p = persistence.NewPersistence(db)
	r, err := p.GetExchangeRateRepository().GetExchangeRates(currency, exchangeRate.GroupID, exchangeRate.Date, exchangeRate.Date)
...
func TestGetExchangeRate(t *testing.T) {
	...
	var p = persistence.NewPersistence(db)
	r, err := p.GetExchangeRateRepository().GetExchangeRate(currency, exchangeRate.GroupID, exchangeRate.Date)
...
func TestUpdateExchangeRate(t *testing.T) {
	...
	var p = persistence.NewPersistence(db)
	err = p.GetExchangeRateRepository().UpdateExchangeRate(exchangeRate)
