...
func TestInsertCategory(t *testing.T) {
	...
	category := Category{Name: "Food", Icon: "restaurant", Color: "red", Description: "Food and drinks", Order: 1, GroupID: 1}
...
func TestGetCategory(t *testing.T) {
	...
	category := Category{ID: 1, Name: "Food", Icon: "restaurant", Color: "red", Description: "Food and drinks", Order: 1, GroupID: 1}
	mock.ExpectQuery("SELECT id, name, icon, color, description, ord, group_id FROM categories").
...
func TestUpdateCategory(t *testing.T) {
	...
	category := Category{ID: 1, Name: "Food", Icon: "restaurant", Color: "red", Description: "Food and drinks", Order: 1}
